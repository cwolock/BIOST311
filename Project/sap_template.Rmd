...
## Background and Introduction (3 point)
...
*For each inferential analysis (e.g. regression) you plan on running, describe the variables you will include, types of estimates and uncertainty quantification you will report, and hypothesis tests you will run. Be specific! Details like confidence level, one- vs. two-sided tests, etc. are important!*
