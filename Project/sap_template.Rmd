...
Submit your SAP on Canvas by 11:59pm on April 29. **Do not discuss your project with other students or post questions about your project on the Canvas discussion board.** But, feel free to ask the instructors any questions in person/via Canvas message instead!
...
TAYLOR: say whatever you can about study design
...
TAYLOR: maybe not defining association thing because logistic regression
...
TAYLOR: every variable they plan on including, not EVERY variable. make this a table if you can (latex?) no need to make table though if not
...
TAYLOR: what type of regression? maybe not bc logistic
...
TAYLOR: maybe not this subsection
