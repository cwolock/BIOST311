...
\begin{itemize}
	\item \textcolor{blue}{Multiple $R^2$}: $$1 - \frac{\sum_{i = 1}^n (Y_i - \hat{Y}_i)^2}{\sum_{i = 1}^n (Y_i - \bar{Y}_i)^2} \hspace{0.3cm} \includegraphics[scale=0.01]{chilipepper.png}$$  [1 - (sum of squared residuals / total sum of squares)] 
