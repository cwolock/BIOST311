...
We will come back to the \textcolor{blue}{normality} and \textcolor{blue}{equal variance} assumptions later in the course, because (as we'll find out) we may not actually need them!
\end{frame}
...
\textcolor{blue}{Answer:} Models 1 and 3 both appear to violate the linearity assumption, but Models 2 and 4 appear okay (the assumption seemingly holds). Diagnostic plots are not a perfect tool for assessing assumptions, and they are subject to (subjective) interpretation! 
\end{frame}
