...
\centering \includegraphics[scale=0.3]{u5mr.pdf}
\end{frame}
...
\centering \includegraphics[scale=0.4]{urban_barplot.pdf}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{urban_hist.pdf}
	\hspace{0.2cm}
	\includegraphics[scale=0.2]{urban_box.pdf}
\end{figure}
