...
b. Suppose we took another sample of size 2500 from the live births in King County. If the standard deviation of birth parent age were larger in this sample, how would a 95\% confidence interval for mean age differ from what you determined in part (a)? Give one sentence explaining your rationale. (1 point)
...
a. An infant is considered premature if born prior to 37 weeks gestation. Create a new binary variable indicating whether each birth in the dataset was premature. Provide relevant descriptive statistics for this new variable. (2 points)
...
b. We are interested in studying the association between premature birth and birthweight. Write a statistical question that will allow us to examine this association through linear regression. What is our population of interest? What is our parameter? (2 points)
...
c. Perform a linear regression analysis to answer the statistical question from part (c). Be sure to include a statistic with appropriate uncertainty quantification, as well as a hypothesis test. (2 points)
...
d. Since premature birth is a binary variable, we could also approach this problem without using linear regression. Perform and interpret a t-test (assuming equal variances) comparing the average birthweight in premature vs. non-premature births. (2 points)
...
e. What do you notice about your results from parts (d) and (e)? Do they agree? (1 point)
